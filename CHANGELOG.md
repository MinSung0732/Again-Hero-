...
- Stage 4 엘리트/미니보스/보스 이벤트 연결: 135초 1차 돌연변이(+증원 8), 270초 2차 돌연변이(+증원 10), 405초 대돌연변이(+증원 14), 480초 오크 보스(+증원 16). 엘리트/미니보스는 기존 편성 몬스터 선택형 돌연변이 시스템을 그대로 사용하며 보스는 HP x8.5 / 공격력 x2.8 / 이동속도 x1.20 / EXP x3.8 / 크기 x1.55로 설정.
