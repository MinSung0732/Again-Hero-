...
const PROFILES = {
	...
	"madness_hero": {
		...
		"berserker": {
			...
			"skill_2": {
				...
				"cell_length": 46.0,
				"cell_count": 8,
				"branch_angle_degrees": 68.0,
				"branch_min_angle_degrees": 28.0,
				"wave_speed": 620.0,
	...
	"chemical_hero": {
		"id": "chemical_hero",
		"display_name": "화학의 용사",
		"archetype": "alchemist_chemical",
		"max_hp": 3400,
		"move_speed": 285.0,
		"attack_damage": 150,
		"level_growth": {
			"base_attack_growth_ratio": 0.012,
			"attack_milestone_interval": 10,
			"attack_milestone_bonus": 0.03,
		},
		"attack_range": 400.0,
		"attack_cooldown": 2.30,
		"projectile_speed": 0.0,
		"exp_pickup_radius": 180.0,
		"ai_sense_radius": 520.0,
		"kite_distance": 245.0,
		...
		"alchemist": {
			...
			"basic_gas_cost": 10.0,
			"basic_vial_count": 3,
			"basic_throw_radius": 400.0,
			"vial_throw_interval": 0.19,
			"vial_flight_duration": 0.46,
			"vial_arc_height": 120.0,
			"poison_duration": 4.0,
			"poison_radius": 206.25,
			"poison_tick_interval": 0.27,
			"poison_tick_damage_ratio": 0.18,
			"gas_per_material": 20.0,
			"material_max_count": 10,
			"initial_material_count": 6,
			"material_spawn_radius": 1500.0,
			"material_spawn_min_radius": 480.0,
			"material_pickup_radius": 72.0,
			"material_spawn_interval": 4.0,
			"low_gas_spawn_interval": 2.0,
			"empty_spawn_interval": 0.8,
			"mixture_field": {
				"id": "alchemist_catalyst_field",
				"name": "촉매 혼합장",
				"cooldown": 20.0,
				"gas_cost": 30.0,
				"radius": 450.0,
				...
				"slow_refresh_seconds": 0.75,
				"hero_move_speed_multiplier": 1.30,
				"run_enter_delay": 0.08,
				"run_exit_delay": 0.12,
				"run_exit_margin": 24.0,
				"heal_interval": 1.0,
				"heal_max_hp_ratio": 0.01,
				"enemy_count_trigger": 2,
			},
			"mystery_cauldron": {
				"id": "alchemist_mystery_cauldron",
				"name": "무엇이 나올까요?",
				"cooldown": 20.0,
				"gas_cost": 0.0,
				"max_active": 2,
				"mix_time_min": 8.0,
				"mix_time_max": 10.0,
				"great_success_chance": 0.20,
				"failure_chance": 0.20,
				"great_success_batches": 5,
				"great_success_vials_min": 4,
				"great_success_vials_max": 5,
				"great_success_batch_interval": 0.32,
				"great_success_throw_radius": 285.0,
				"great_success_damage_ratio": 0.45,
				"great_success_hit_radius": 105.0,
				"success_material_count": 7,
				"success_heal_item_count": 3,
				"success_drop_duration": 10.0,
			},
		},
		"augment_pool_ids": [
			"common_attack_training",
